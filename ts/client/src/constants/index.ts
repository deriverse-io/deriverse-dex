...
export const MANGO_V4_ID = {
  ...
  'mainnet-beta': new PublicKey('8AHhgx8bNF4oejgfUzN6A7ZN1CPrh8NMsgnrcDiNgUiZ'), // TODO: change
  // 'mainnet-beta': new PublicKey('4MangoMjqJ2firMokCjjGgoK8d4MXcrgL7XJaL3w6fVg'), // TODO: change
};
